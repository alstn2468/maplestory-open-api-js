...
export interface RankingOverAllQueryParameter extends RankingQueryParameter {
  /** 월드 명 */
  world_name: World;
  /** 월드 타입 (0:일반, 1:리부트) (기본 값은 0이며, world_name 입력 시 미 반영) $byte */
...
export interface RankingUnionQueryParameter extends RankingQueryParameter {
  /** 월드 명 */
  world_name: World;
  /** 캐릭터 식별자 */
  ocid: string;
...
export interface RankingGuildQueryParameter extends RankingQueryParameter {
  /** 월드 명 */
  world_name: World;
  /** 길드 명 */
  guild_name: string;
  /** 랭킹 타입 (0:주간 명성치, 1:플래그 레이스, 2:지하 수로) $byte */
  ranking_type: RankingType;
}

export interface RankingDojangQueryParameter extends RankingQueryParameter {
  /** 월드 명 */
  world_name: World;
  /** 구간 (0:일반, 1:통달) $int32 */
  difficulty: number;
...
export interface RankingTheSeedQueryParameter extends RankingQueryParameter {
  /** 월드 명 */
  world_name: World;
  /** 캐릭터 식별자 */
  ocid: string;
...
export interface RankingAchievementQueryParameter
